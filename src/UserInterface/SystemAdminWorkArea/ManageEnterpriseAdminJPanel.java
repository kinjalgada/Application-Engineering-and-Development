...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Add Enterprise Admin");
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        try {
            ...
            Employee employee = enterprise.getEmployeeDirectory().createEmployee(name, phone, email, dob);
            Customer customer = null;
            UserAccount account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, customer, new AdminRole());
            populateTable();
        } catch (Exception e) {
        }
