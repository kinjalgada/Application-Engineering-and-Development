...
public class EditEmployeeJPanel extends javax.swing.JPanel {
     ...
     */
    public EditEmployeeJPanel(JPanel userProcessContainer,Employee employee, OrganizationDirectory organizationDirectory) {
        initComponents();
        ...
        txtDOB.setText(String.valueOf(employee.getDob()));
        
        
        orgEmpJComboBox.setEditable(false);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        employee.setName(String.valueOf(txtName.getText()));
        employee.setDob(String.valueOf(txtDOB.getText()));
        employee.setPhone(String.valueOf(txtPhone.getText()));
        employee.setEmail(String.valueOf(txtEmail.getText()));
