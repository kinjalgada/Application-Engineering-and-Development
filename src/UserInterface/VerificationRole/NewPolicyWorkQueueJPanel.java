 ...
 * @author raunak
 */
public class NewPolicyWorkQueueJPanel extends javax.swing.JPanel {
     ...
     */
    public NewPolicyWorkQueueJPanel(JPanel userProcessContainer, UserAccount account, VerificationOrganization organization, Enterprise enterprise) {
        initComponents();
    ...
    public void populateTable(){
        ...
        for(WorkRequest request : verOrganization.getWorkQueue().getWorkRequestList()){
            if(request.getClass().equals(RequestVerificationNewPolicy.class)) 
            {
    ...
    private void initComponents() {
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Message", "Sender", "Receiver", "Status", "Request Date", "Policy"
            }
        ) {
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        RequestVerificationNewPolicy request = (RequestVerificationNewPolicy)workRequestJTable.getValueAt(selectedRow, 0);
...
//        if(request.getReceiver().getUserName().length()>0){
        if(request.getReceiver().getUserName().equals(userAccount.getUserName())){
            ...
            ProcessNewPolicyVerificationWorkRequestJPanel processNewPolicyVerificationWorkRequestJPanel = new ProcessNewPolicyVerificationWorkRequestJPanel(userProcessContainer, request);
            userProcessContainer.add("ProcessNewPolicyVerificationWorkRequestJPanel", processNewPolicyVerificationWorkRequestJPanel);
